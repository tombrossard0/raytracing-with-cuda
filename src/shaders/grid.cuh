...
__device__ __forceinline__ bool intersectGrid(const Ray &ray, float &t) {
...
__device__ __forceinline__ Vec3 gridColor(const Vec3 &point, float gridSize = 1.0f, float lineWidth = 0.02f) {
